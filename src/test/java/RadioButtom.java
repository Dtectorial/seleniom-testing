...
public class RadioButtom {
    ...
    void defaultCheckBoxSelectionTest() throws MalformedURLException {
        ...
        Assert.assertFalse(javaRadio.isSelected(),"Java Radio is Checked");
        Assert.assertFalse(phpRadio.isSelected(),"php Radio is Checked");
    ...
    @Test
    void javaRadioCheckBoxSelectionTest() throws MalformedURLException {
        System.setProperty("webdriver.chrome.driver","drivers/chromedriver.exe");
        WebDriver webDriver = new ChromeDriver();
        webDriver.manage().window().maximize();
        String url = "http://www.testdiary.com/training/selenium/selenium-test-page/";
        ...
        javaRadio.click();
        WebElement phpRadio = webDriver.findElement(By.cssSelector("input[id='php1'][type='radio']"));
        Assert.assertTrue(javaRadio.isSelected(),"Java Radio is Checked");
        Assert.assertFalse(phpRadio.isSelected(),"php Radio is Checked");
        WebElement saveButton = webDriver.findElement(By.cssSelector("button[id='demo']"));
        Assert.assertTrue(saveButton.isDisplayed(),"Save Button is not displayed.");
        webDriver.quit();
    ...
    @Test
    void phpRadioCheckBoxSelectionTest() throws MalformedURLException {
        System.setProperty("webdriver.chrome.driver", "drivers/chromedriver.exe");
        WebDriver webDriver = new ChromeDriver();
        webDriver.manage().window().maximize();
        String url = "http://www.testdiary.com/training/selenium/selenium-test-page/";
        ...
        phpRadio.click();
        Assert.assertFalse(javaRadio.isSelected(), "Java Radio is Checked");
        Assert.assertTrue(phpRadio.isSelected(), "php Radio is Checked");
        WebElement saveButton = webDriver.findElement(By.cssSelector("button[id='demo']"));
        Assert.assertTrue(saveButton.isDisplayed(), "Save Button is not displayed.");
        webDriver.quit();
    }
    @Test
    void javaAndPhpRadioCheckBoxSelectionTest() throws MalformedURLException {
        System.setProperty("webdriver.chrome.driver","drivers/chromedriver.exe");
        WebDriver webDriver = new ChromeDriver();
        webDriver.manage().window().maximize();
        String url = "http://www.testdiary.com/training/selenium/selenium-test-page/";
